...
export const i18nDict: Record<Language, I18nDictionary> = {
  en: {
    ...
    searchByControlNumberPropertyOrDescription: 'Search by control number, property, or description...',
    cost_under50k: 'Cost under $50k',
    cost_50k_100k: 'Cost between $50k and $100k',
    cost_over100k: 'Cost over $100k',
    ...
    year: 'Year',
    cost_under1000: 'Cost under $1000',
    cost_1000_5000: 'Cost between $1000 and $5000',
    cost_over5000: 'Cost over $5000',
    ...
    startTendering: 'Start Tendering',
    addTender: 'Add Tender',
    createTender: 'Create Tender',
    editTender: 'Edit Tender',
    deleteTender: 'Delete Tender',
    awardTender: 'Award Tender',
    cancelTendering: 'Cancel Tendering',
    noTenders: 'No tenders yet',
    tenderStatus: 'Tender Status',
    tenderStatusPending: 'Pending',
    tenderStatusSubmitted: 'Submitted',
    tenderStatusAwarded: 'Awarded',
    tenderStatusRejected: 'Rejected',
    tenderStatusCancelled: 'Cancelled',
    company: 'Company',
    ...
    tenderingFee: 'Tendering Fee',
    submissionDate: 'Submission Date',
    tenderDeadline: 'Tender Deadline',
    awardedDate: 'Awarded Date',
    uploadDocuments: 'Upload Documents',
    tenderDocuments: 'Tender Documents',
    tenderInstructions: 'Tender Instructions',
    contract: 'Contract',
    proposal: 'Proposal',
    noDocumentsUploaded: 'No documents uploaded',
    viewAllTenders: 'View All Tenders',
    backToWorkOrder: 'Back to Work Order',
    confirmAwardTender: 'Confirm Award This Tender',
    awardTenderMessage: 'Are you sure you want to award this tender? A control number will be generated automatically.',
    awardedSuccessfully: 'Tender awarded successfully',
    tenderDeletedSuccessfully: 'Tender deleted successfully',
    confirmDeleteTender: 'Are you sure you want to delete this tender?',
    tenderAddedSuccessfully: 'Tender added successfully',
    tenderUpdatedSuccessfully: 'Tender updated successfully',
    selectCompany: 'Select Company',
    enterFee: 'Enter Fee (HKD)',
    selectSubmissionDate: 'Select Submission Date',
    selectDeadline: 'Select Deadline',
    feeIsRequired: 'Fee is required and must be greater than 0',
    submissionDateAfterDeadline: 'Submission date cannot be after the deadline',
    awardedTender: 'Awarded Tender',
    tenderingFeeLabel: 'Fee (HKD)',
    ...
    noRelatedTenders: 'No tenders have been submitted for this work order yet',
    tenderManagementTitle: 'Manage Tenders for Work Order',
    tenderDetailTitle: 'Tender Details - ',
  },
  ...
  'zh-Hant': {
    ...
    dayNameFri: '星期五',
    dayNameSat: '星期六',
    monthName_january: '一月',
    monthName_february: '二月',
    monthName_march: '三月',
    monthName_april: '四月',
    monthName_may: '五月',
    monthName_june: '六月',
    monthName_july: '七月',
    monthName_august: '八月',
    monthName_september: '九月',
    monthName_october: '十月',
    monthName_november: '十一月',
    monthName_december: '十二月',
    previousMonth: '上一個月',
    nextMonth: '下一個月',
    calendarExpired: '已過期',
    ...
    cost_under50k: '成本低於$50k',
    cost_50k_100k: '成本在$50k到$100k之間',
    cost_over100k: '成本高於$100k',
    ...
    deleteFile: '刪除文件',
    cost_under1000: '成本低於1000',
    cost_1000_5000: '成本在1000到5000之間',
    cost_over5000: '成本高於5000',
    ...
    deleteTender: '刪除投標',
    awardTender: '公布中標',
    cancelTendering: '取消投標',
    noTenders: '暫無投標',
    tenderStatus: '投標狀態',
    tenderStatusPending: '待審',
    tenderStatusSubmitted: '已提交',
    tenderStatusAwarded: '已中標',
    tenderStatusRejected: '未中標',
    tenderStatusCancelled: '已取消',
    company: '公司',
    companyName: '公司名稱',
    ...
    tenderDocuments: '投標文件',
    tenderInstructions: '投標說明書',
    contract: '合約',
    proposal: '方案書',
    noDocumentsUploaded: '未上傳任何文件',
    viewAllTenders: '查看全部投標',
    backToWorkOrder: '返回工作單',
    confirmAwardTender: '確認公布中標',
    awardTenderMessage: '確認公布此投標為中標方案嗎？系統會自動生成控制編號。',
    awardedSuccessfully: '投標已成功公布為中標',
    tenderDeletedSuccessfully: '投標已成功刪除',
    confirmDeleteTender: '確認刪除此投標嗎？',
    tenderAddedSuccessfully: '投標已成功新增',
    tenderUpdatedSuccessfully: '投標已成功更新',
    selectCompany: '選擇公司',
    enterFee: '輸入費用 (港元)',
    selectSubmissionDate: '選擇投標日期',
    selectDeadline: '選擇截標日期',
    feeIsRequired: '費用為必填項，且必須大於0',
    submissionDateAfterDeadline: '投標日期不可遲於截標日期',
    awardedTender: '中標投標',
    tenderingFeeLabel: '費用 (港元)',
    submittedOn: '投標於',
    deadline: '截標',
    tableHeaderCompany: '公司',
    tableHeaderFee: '費用',
    tableHeaderStatus: '狀態',
    tableHeaderSubmitted: '投標日期',
    tableHeaderDeadline: '截標日期',
    tableHeaderActions: '操作',
    noRelatedTenders: '此工作單尚未收到任何投標',
    tenderManagementTitle: '管理工作單投標',
    tenderDetailTitle: '投標詳情 - ',
  },
};

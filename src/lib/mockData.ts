...
export const mockMaintenanceRequests: MaintenanceRequest[] = [
 {
  ...
  propertyId: 'prop-001',
  title: '維修廚房水龍頭滲漏',
  description: '廚房水龍頭於夜間出現滴水情況，需安排檢查及維修以防止浪費用水。',
  priority: 'medium',
  status: 'open',
...
},
{
  ...
  propertyId: 'prop-002',
  title: '更換冷氣系統風隔',
  description: '空調（HVAC）系統風隔需要更換，以維持系統正常運作及空氣質素。',
  priority: 'low',
  status: 'completed',
...
},
{
  id: 'maint-003',
  propertyId: 'prop-002',
  title: '更換 Trane 空調機組（保養期已過）',
  description: '空調機組保養期已於 2025-03-10 屆滿。需進行天台檢查及機組更換，以防止滲水及相關水浸風險。',
  priority: 'urgent',
  status: 'in_progress',
...
},
{
  id: 'maint-004',
  propertyId: 'prop-002',
  title: '更換 Lennox 空調機組（保養期已過）',
  description: '空調機組保養期已於 2024-11-22 屆滿。目前設備狀況一般，建議進行預防性更換。',
  priority: 'high',
  status: 'open',
...
},
{
  ...
  propertyId: 'prop-002',
  title: '維修停車場路面凹洞',
  description: '停車場路面出現大型凹洞，構成安全隱患，需盡快安排維修工程。',
  priority: 'high',
  status: 'in_progress',
